const app1 = new Moon({
	...
	data: {
		...
		sec2_text2:
		"O valor do serviço é de R$ 4,99/semana ou de R$12,99/mês (desconto de 13%) mas você também tem a opção de acessar todas as aulas gratuitas no app até encontrar o curso que vai querer!",
